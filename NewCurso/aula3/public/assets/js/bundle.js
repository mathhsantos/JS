...
/* harmony export */ });
/* harmony import */ var _validaCpfClass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./validaCpfClass */ "./src/modules/validaCpfClass.js");
...
var geraCPF = /*#__PURE__*/function () {
  ...
  _createClass(geraCPF, [{
    ...
    value: function geraNovoCpf() {
      ...
      var cpf = new _validaCpfClass__WEBPACK_IMPORTED_MODULE_0__.CPF(cpfSemDigito);
      var result = cpf.validaCPF(cpfSemDigito);
...
var CPF = /*#__PURE__*/function () {
  ...
  _createClass(CPF, [{
    key: "validaCPF",
    value: function validaCPF(num) {
      var digito1 = String(this.digito(num));
      var digito2 = String(this.digito(num + digito1));
      var digitos = this.cpf.slice(0, 9) + digito1 + digito2;
    ...
    key: "digito",
    value: function digito(num) {
      var cpfArray = Array.from(num);
      var soma = cpfArray.reduce(function (contador, valor, indice) {
...
function global() {
  var gera = new _modules_geraCpf_js__WEBPACK_IMPORTED_MODULE_0__.geraCPF();
